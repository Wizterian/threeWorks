export default class Smoke {
  constructor(threeScene) {
    ...
    Object.assign(this, options, defaults); // add some other props
  ...
  addBackground() {
    ...
    textureLoader.load('https://picsum.photos/id/237/1600/900', texture => {
  ...
  render() {
    ...
    mesh.position.z = 1000 + Math.sin(cubeSineDriver) * 500;
